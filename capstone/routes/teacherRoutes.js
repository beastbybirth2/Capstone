...
router.get("/welcome",ensureTeacher,  (req, res) => {
  res.render("teachers/welcome");
});

router.get("/dashboard",ensureTeacher,  (req, res) => {
  res.render("teachers/dashboard");
});

router.get("/chat",ensureTeacher,  (req, res) => {
  res.render("teachers/chatTeacher");
});

router.get("/addStudents",ensureTeacher,  (req, res) => {
  res.render("teachers/addStudents");
});

router.get("/sendRequest",ensureTeacher,  (req, res) => {
  res.render("teachers/sendRequest");
});

router.get("/createQuiz",ensureTeacher,  (req, res) => {
  res.render("teachers/createQuiz");
});

router.get("/getscores/:id",ensureTeacher,  (req, res) => {
  const id = req.params.id;
  console.log(id);
  res.render("teachers/getScores", { id });
});

router.get("/get-student",  ensureTeacher, async (req, res) => {
